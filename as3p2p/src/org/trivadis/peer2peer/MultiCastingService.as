package org.trivadis.peer2peer {
	...
	[Event(name="connected", type="org.trivadis.events.ServiceEvent")]
	[Event(name="disconnected", type="org.trivadis.events.ServiceEvent")]
	[Event(name="peerconnect", type="org.trivadis.events.ServiceEvent")]
	[Event(name="peerdisconnect", type="org.trivadis.events.ServiceEvent")]
	[Event(name="result", type="org.trivadis.events.ServiceEvent")]
	...
	public class MultiCastingService extends EventDispatcher {
		...
		private var groupName:String = "org.trivadis/";
		...
		private static const SERVER:String = "rtmfp://p2p.rtmfp.net/739613ec0d7a601688624a02-a23068435d08/";
		//private static const SERVER:String = "USE_YOUR_OWN_RTMFP_ID";
		
		public function MultiCastingService(user:String=null, logEnabled:Boolean = false, gn:String="trivadisairdemo", ip:String="224.0.0.1:4000", target:IEventDispatcher=null) {
			super(target);
			if (user){
				userName = user;
			}
